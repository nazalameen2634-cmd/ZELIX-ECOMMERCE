              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-x-5 gap-y-12">
                {Array(8).fill(null).map((_, i) => (
                  <div key={i} className="flex flex-col gap-4">
                    <div className="w-full rounded-2xl shimmer-bg" style={{ aspectRatio: '3/4' }} />
      ...
      <Modal isOpen={!!quickViewProduct} onClose={() => setQuickViewProduct(null)} title="" maxWidth="lg">
        {quickViewProduct && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="w-full overflow-hidden rounded-2xl border" style={{ aspectRatio: '3/4', background: '#111', borderColor: 'rgba(232,227,220,0.06)' }}>
